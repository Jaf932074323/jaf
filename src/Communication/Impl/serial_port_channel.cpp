...
{
	if (CreateIoCompletionPort(comm_handle_, completion_handle_, (ULONG_PTR)comm_handle_, 0) == nullptr)
	{
...
Coroutine<bool> SerialPortChannel::Read(unsigned char* buff, size_t buff_size, size_t* recv_len)
{
...
Coroutine<bool> SerialPortChannel::Write(const unsigned char* buff, size_t buff_size)
{
